...
options = Options()
# Webdriver
browser = webdriver.Chrome("C:\Users\lerod\Desktop\BIJUS Daniel\PRO_1-1_C128_AtividadeDaProfessora2\chromedriver-win64")
    ...
    for i in range(1,2):
        while True:
            ...
            if current_page_num < i:
                browser.find_element(By.CSS_SELECTOR, 'a[title="Next page"]').click()
            elif current_page_num > i:
                browser.find_element(By.CSS_SELECTOR, 'a[title="Previous page"]').click()
            else:
                break
        ...
        for ul_tag in soup.find_all("ul", attrs={"class", "exoplanet"}):
            ...
            ## ADICIONE O CÓDIGO AQUI ##
            temp_list.append("https://exoplanets.nasa.gov"+ hyperlink_li_tag.find_all("a",
href=True)[0]["href"])
